...
// Smaller Devices
function smallerDevicesModals() {
    // Stats
    const stats = document.getElementById('stats');

    // Button View Stats
    const btnViewStats = document.getElementById('stats-btn');

    btnViewStats.addEventListener('click', () => {
        if (!document.querySelector('.div-stats')) {
            const divStats = document.createElement('div');
            divStats.classList.add("div-stats");
            divStats.style.cssText = "display: flex; align-items: center; justify-content: center; position: fixed; top: 0; left: 0; height: 100vh; width: 100%; z-index: 100; background-color: #000000b5; transition: all 0.3s;";
            ...
            divStats.style.pointerEvents = "all";
        }
        
        stats.style.opacity = 1;
        stats.style.pointerEvents = "all";
    });
    ...
    // Button View Themes
    const buttonThemes = document.getElementById('btn-themes-sm');

    buttonThemes.addEventListener('click', () => {
        if (!document.querySelector('.div-themes')) {
            const divThemes = document.createElement('div');
            divThemes.classList.add("div-themes");
            divThemes.style.cssText = "display: flex; align-items: center; justify-content: center; position: fixed; top: 0; left: 0; height: 100vh; width: 100%; z-index: 100; background-color: #000000b5; transition: all 0.3s;";
            divThemes.appendChild(themes);
            document.body.appendChild(divThemes);
        } else {
            const divThemes = document.querySelector('.div-themes');
            divThemes.style.opacity = 1;
            divThemes.style.pointerEvents = "all";
        }

        themes.style.opacity = 1;
        themes.style.pointerEvents = "all";
    });

    const buttonStandardThemes = document.getElementById('standard-themes-btn');
    buttonStandardThemes.addEventListener('click', () => {
        if (!!document.querySelector('.div-themes')) {
            const divThemes = document.querySelector('.div-themes');
            divThemes.style.opacity = 0;
            divThemes.style.pointerEvents = "none";

            themes.style.opacity = 0;
        themes.style.pointerEvents = "none";
        }
    });

    const buttonPremiumThemes = document.getElementById('premium-themes-btn');
    buttonPremiumThemes.addEventListener('click', () => {
        if (!!document.querySelector('.div-themes')) {
            const divThemes = document.querySelector('.div-themes');
            divThemes.style.opacity = 0;
            divThemes.style.pointerEvents = "none";
    ...
    window.addEventListener('click', function(e) {
        ...
        if (!!document.querySelector('.div-stats')) {
            const divStats = document.querySelector('.div-stats');
            if (e.target == divStats) {
                divStats.style.opacity = 0;
                divStats.style.pointerEvents = "none";
